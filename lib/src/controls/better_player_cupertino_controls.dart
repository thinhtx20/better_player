...
class _BetterPlayerCupertinoControlsState extends BetterPlayerControlsState<BetterPlayerCupertinoControls> with SingleTickerProviderStateMixin {
        ...
        child: AbsorbPointer(
          ...
          child: Stack(fit: StackFit.expand, children: [
            ...
            (_betterPlayerController!.isHidechart && _betterPlayerController!.isFullScreen)
                ...
                right: 40,
                child: Visibility(
                    visible: _betterPlayerController!.isHidechart,
            ...
            Positioned(
              bottom: 0,
              left: 0,
              right: _betterPlayerController!.isFullScreen ? 10 : 0,
  ...
  InkWell _buildHidechat(
    ...
    return InkWell(
      onTap: _onHide,
      child: AnimatedOpacity(opacity: controlsNotVisible ? 0.0 : 1.0, duration: _controlsConfiguration.controlsHideTime, child: _betterPlayerController!.isHidechart ? _controlsConfiguration.showChatIcon : _controlsConfiguration.hideChatIcon),
    );
  }
          ...
          child: Row(
            children: [
              ...
              Row(
                children: [
                  Icon(
                    _controlsConfiguration.eyeWatchingIcon,
                    color: _controlsConfiguration.textColor,
                  ),
                  SizedBox(
                    width: 5,
  ...
  Widget _buildTopBar(
    ...
    return AnimatedOpacity(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            if (_controlsConfiguration.enableTittle && _betterPlayerController!.isFullScreen) _buildTittle(iconColor, barHeight) else  _controlsConfiguration.titleVideo,
            // const Spacer(),
            // const SizedBox(
            //   width: 4,
            // ),
          ...
          showModalBottomSheet<void>(
            ...
            builder: (BuildContext context) {
              return Padding(
                  ...
                  child: SafeArea(
                    child: _controlsConfiguration.chatVideo,
                  ));
            },
          );
        },
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    '${_controlsConfiguration.textHint}',
